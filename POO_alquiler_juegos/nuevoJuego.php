...
if(isset($_POST['añadir'])){
    ...
    if(is_uploaded_file($_FILES['foto']['tmp_name'])){
        ...
        $juego->nuevoJuego($result."-".$_POST['consola'],$_POST['nombre'],$_POST['consola'],$_POST['aÃ±o'],$_POST['precio'],'NO',$ruta,$_POST['descripcion']);
        ...
        <div class="ml-5 mt-4">
            ...
            ?>
                     ...
                     <form  class="form-vertical" action="" method="post" enctype="multipart/form-data">
                         ...
                         <br>
                         Año: <input class="form-control" type="number" name="aÃ±o">
                         <br>
