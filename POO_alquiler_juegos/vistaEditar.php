...
if (isset($_POST['modificar'])) {
    ...
    if ($_FILES['foto']['size'] > 0) {
        ...
        if (is_uploaded_file($_FILES['foto']['tmp_name'])) {
            ...
            //para copiar el fichero en la carpeta usamos la función move_uploaded_file
            move_uploaded_file($_FILES['foto']['tmp_name'], $ruta);

            $juego = new Juegos();
            $juego->nuevoJuego($_POST['codigo'], $_POST['nombre'], $_POST['consola'], $_POST['aÃ±o'], $_POST['precio'], 'NO', $ruta, $_POST['descripcion']);
        ...
        $juego = new Juegos();
        $juego->nuevoJuego($_POST['codigo'], $_POST['nombre'], $_POST['consola'], $_POST['aÃ±o'], $_POST['precio'], 'NO', $_POST['foto'], $_POST['descripcion']);
        controladorJuego::modificarJuego($juego);
        header('location:administrarJuegos.php');
    }
}
                        ...
                        <div class="col-sm-8">
                            ...
                            <form  class="form-vertical" action="" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <br>
                                    Año: <input class="form-control" type="number" name="aÃ±o" value="<?php echo $juego->anno ?>">
                                    <br>
