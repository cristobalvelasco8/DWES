    ...
    while ($row = $pago->fetchObject()) {
        ...
        if ($df > 7) {
            ...
            <div class="alert alert-danger">
                Has tenido el juego <strong><?php echo $df; ?></strong> dias Tienes que pagar <strong><?php echo $total; ?>€ </strong> .
            </div>
            <?php
        } else {
            ?>
            ...
            <div class="alert alert-success">
                Has tenido el juego <strong><?php echo $df;  ?></strong> dias Tienes que pagar <strong><?php echo $pagar; ?>€ </strong> .
            </div>
            <?php
        }
    }
